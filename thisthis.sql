...
--
CREATE DATABASE IF NOT EXISTS `fengshui db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `fengshui db`;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
...
('root', '[{\"db\":\"fengshui db\",\"table\":\"orders\"},{\"db\":\"information_schema\",\"table\":\"COLUMNS\"},{\"db\":\"fengshui db\",\"table\":\"payments\"},{\"db\":\"fengshui db\",\"table\":\"products\"},{\"db\":\"fengshui db\",\"table\":\"users\"},{\"db\":\"fengshui db\",\"table\":\"sessions\"}]');
